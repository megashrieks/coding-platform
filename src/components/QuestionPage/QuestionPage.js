...
class QuestionPage extends Component{
    ...
    render() {
        let testCases = this.state.data.test_cases && this.state.data.test_cases.map((element, index) => {
            return(
        ...
        let testCaseResults = this.state.data.test_case_results && this.state.data.test_case_results.map((element, index) => {
            return (
