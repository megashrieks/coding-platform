...
class QuestionPage extends Component{
    ...
    render() {
        let testCases = this.state.data.testCases && this.state.data.testCases.map((element, index) => {
            return(
        ...
        let testCaseResults = this.state.data.testCaseResults && this.state.data.testCaseResults.map((element, index) => {
            return (
